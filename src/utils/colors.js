...
export function varKind(v) {
  ...
  if (v.startsWith('--chat-background') || v === '--color-code-background' || v === '--table-header' || v === '--table-row-bg' || v === '--local-thinking-bg' || v === '--local-input-border' || v === '--color-inline-code-bg') return 'panel'
  if (v === '--table-header-text' || v === '--color-reference-text' || v === '--color-inline-code-text') return 'panelText'
