...
export const TOKEN_REGISTRY = [
  ...
  },
  {
    ...
    themeKey: 'primaryColor', defaultDark: '#E899754d', defaultLight: '#E899754d',
    recipe: { type: 'alphaOf', alpha: 0.3 },
  ...
  /* ═══════════════════════ Sidebar and Navigation ═══════════════════════ */
  {
    ...
    themeKey: 'navbarBg', defaultDark: '#303030', defaultLight: '#f4f4f4',
  ...
  },
  {
    ...
    themeKey: 'navbarBg', defaultDark: 'rgba(20,20,20,0.55)', defaultLight: 'rgba(255,255,255,0.55)',
  ...
  /* ═══════════════════════ Input Area ═══════════════════════ */
  {
    ...
    themeKey: 'inputBg', alphaKey: { dark: 'inputOpacityDark', light: 'inputOpacityLight' },
  ...
  },
  {
    ...
    themeKey: 'inputBorder', alphaKey: { dark: 'inputBorderOpacityDark', light: 'inputBorderOpacityLight' },
  ...
  /* ═══════════════════════ Borders and Dividers ═══════════════════════ */
  {
    ...
    themeKey: 'globalBorder', alphaKey: { dark: 'globalBorderOpacityDark', light: 'globalBorderOpacityLight' },
    defaultDark: '#ffffff', defaultLight: '#000000',
  ...
  {
    id: 'tableHeaderText', officialKey: '--local-table-header-text', group: 'codemarkdown', valueMode: 'per-mode',
    valueType: 'color', kind: 'extension',
    label: { en: 'Markdown Table Header Text', zh: '表格表头文字' },
    description: { en: 'Header text color of markdown tables (theme-station structural var).', zh: 'Markdown 表格表头文字颜色（扩展结构变量）。' },
    themeKey: 'tableHeaderText', defaultDark: '#f0f0f0', defaultLight: '#1b1b1f',
    previewTargets: ['table-header'],
    officialSource: station('src/App.css', '--table-header-text'),
  },
  {
